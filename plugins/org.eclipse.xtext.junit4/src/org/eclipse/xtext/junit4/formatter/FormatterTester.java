...
public class FormatterTester {
	...
	@Inject
	private Provider<TextRegionAccessBuildingSequencer> serializerBasedRegionAccessBuilderProvider;
	...
	protected ITextRegionAccess createRegionAccessViaSerializer(XtextResource resource) {
		...
		TextRegionAccessBuildingSequencer builder = serializerBasedRegionAccessBuilderProvider.get().withRoot(root);
